...
class ModelsTestCase(TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.user2.repos.add(cls.repo2)
        cls.user2.repos.add(cls.repo3)
    
        cls.tag1 = Tag.objects.create(id=1, name="tag1", user=cls.user1)
        cls.tag2= Tag.objects.create(id=2,  name="tag2", user=cls.user2)
        cls.tag3 =Tag.objects.create(id=3,  name="tag3", user=cls.user2)
    ...
    #conta numeros de usuarios 
    def test_user_count(self):
        a = User.objects.count()
        self.assertEquals(a, 2)

    #conta tags de cada um 
    ...
    #conta quantidade de repositorios para cada um
    def test_repo_count(self):
        self.assertEquals(self.user1.repos.count(), 2)
        self.assertEquals(self.user2.repos.count(), 2)

    #testa se tag inseridada em repositório comum nao aparece nos dois usuarios 
