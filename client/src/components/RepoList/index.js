    ...
    return (
        <div id='repo-list' className='container-sm'>
            ...
            {repositories.map((repo) => (
                <Repo id={repo.id} name={repo.name} description={repo.description} url={repo.html_url} />
            ))}

            {!loading && repositories.length === 0 && (
                <div class='blankslate text-center anim-fade-in'>
                    <h3 class='mb-1'>Hmmm, parece que voce não adicionou nenhuma estrela!</h3>
